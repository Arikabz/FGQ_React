    ...
    return (
        <footer className="footer items-center p-4 bg-neutral text-neutral-content">
            <div className="items-center grid-flow-col">
                ...
                <p><a href='https://agsoftwarez.com' className='link link-primary' target='blank'>Copyright \u00a9 AG Softwarez 2022</a> - All right reserved</p>
            </div> 
